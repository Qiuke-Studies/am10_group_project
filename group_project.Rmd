...
library(jtools)
effect_plot(model2, pred = poverty_rate, interval = TRUE)

```



```{r choosing ols model}
#ANOVA analysis
...
# Make predictions
predictions_lasso <- predict(lasso_final,testing_cpi)
...
```{r summary of models performance}
